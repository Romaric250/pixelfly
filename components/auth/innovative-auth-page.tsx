            ...
            <div className="space-y-4 max-w-sm mx-auto">
              ...
              >
                <Button
                  ...
                  disabled={isLoading}
                  className="w-full h-14 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                >
              ...
              >
                <Button
                  ...
                  variant="outline"
                  className="w-full h-14 border-purple-200 text-purple-600 hover:bg-purple-50 hover:border-purple-300 rounded-2xl font-semibold text-lg"
                >
